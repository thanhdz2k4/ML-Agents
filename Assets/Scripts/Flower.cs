...
public class Flower : MonoBehaviour
{
    ...
    public Color fullFowerColor = new Color(1f, 0f, 0.3f);

    [Tooltip("The color when the flower is empty")]
    public Color emptyFowerColor = new Color(0.5f, 0f, 1f);

    /// <summary>
    /// The trigger collider representing the nactar
    /// </summary>
    [HideInInspector]
    ...
    /// </summary>
    /// <param name="amount">the amount of nectar tp remove</param> 
    ...
    public float Feed(float amount)
    {
        ...
        if(NectarAmount <= 0)
        {
            ...
            flowerMaterial.SetColor("_BaseColor", emptyFowerColor);
        }
